...
count = 0
for path in os.listdir("/root/pic")[:]:
    img_path = "/root/pic/"+path
    # print(img_path)
    try:
        # img_path = "t2.jpg"
        ...
        # print( round(prediction.item(),5))
        count+=1
        print(count,path,round(prediction.item(),5))
        print(path+"&"+str(round(prediction.item(),5)),file=fs)
    except:
        count+=1
        print(count,path,'')
        print(path+"&"+'',file=fs)
